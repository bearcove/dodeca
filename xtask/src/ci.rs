...
"#
        ...
        // The browser editor package file-links `hotmeal-wasm`, whose pkg is
        // generated by wasm-pack. Build the absorbed Hotmeal wasm package before
        // build.rs runs the editor bundle. Linux only: that's the platform the kb
        // installs; macOS degrades to an empty editor (build still succeeds).
